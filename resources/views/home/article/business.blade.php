...
<div class="page-content">
    ...
    <div class="all-sever-page w1200">
        <div id="news-main">
            ...
            <dl>
                <dd><a href="/b_content/{{$item->id}}"><img src="{{env('IMG_URL').$item->thumb}}"></a></dd>
                <dt><h5>{{$item->title}}</h5>
                    <p>{{$item->description}}<a href="/b_content/{{$item->id}}">查看详情</a>
                    </p>
        ...
        <div class="fr">
            <div class="fr-box">
                ...
                <div class="story-list">
                    @foreach($new as $item)
                    <a href="/b_content/{{$item->id}}" class="">{{$item->title}}</a>
                        @endforeach
                </div>
            </div>
        </div>
