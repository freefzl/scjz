...
@section('content')
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <form class="layui-form" action="{{route('about.concept.update')}}" method="post">
                {{csrf_field()}}
                {{method_field('put')}}
                        ...
                        <div class="layui-upload">
                            ...
                            <div class="layui-upload-list" >
                                <ul id="layui-upload-box" class="layui-clear">
                                    @if(isset($concept->img))
                                        <li><img src="{{ env('IMG_URL').$concept->img }}" /><p>上传成功</p></li>
                                    @endif
                                </ul>
                                <input type="hidden" name="img" id="thumb" value="{{ $concept->img??'' }}">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <script id="container" name="content" type="text/plain">
                            {!! $concept->content??old('content') !!}
                        </script>
                    </div>
                </div>
                @can('about.concept.edit')
                <div class="layui-form-item">
                    <div class="layui-input-block my_width">
