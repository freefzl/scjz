...
@section('content')
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <form class="layui-form" action="{{route('about.company.update')}}" method="post">
                {{csrf_field()}}
                {{method_field('put')}}
                        ...
                        <div class="layui-upload">
                            ...
                            <div class="layui-upload-list" >
                                <ul id="layui-upload-box" class="layui-clear">
                                    @if(isset($company->img))
                                        <li><img src="{{ env('IMG_URL').$company->img }}" /><p>上传成功</p></li>
                                    @endif
                                </ul>
                                <input type="hidden" name="img" id="thumb" value="{{ $company->img??'' }}">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <script id="container" name="content" type="text/plain">
                            {!! $company->content??old('content') !!}
                        </script>
                    </div>
                </div>

                @can('about.company.edit')
                    <div class="layui-form-item">
                        <div class="layui-input-block my_width">
