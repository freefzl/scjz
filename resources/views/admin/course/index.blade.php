...
@section('content')
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <form class="layui-form" action="{{route('about.course.update')}}" method="post">
                {{csrf_field()}}
                {{method_field('put')}}
                        ...
                        <div class="layui-upload">
                            ...
                            <div class="layui-upload-list" >
                                <ul id="layui-upload-box" class="layui-clear">
                                    @if(isset($course->img))
                                        <li><img src="{{ env('IMG_URL').$course->img }}" /><p>上传成功</p></li>
                                    @endif
                                </ul>
                                <input type="hidden" name="img" id="thumb" value="{{ $course->img??'' }}">
